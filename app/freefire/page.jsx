      ...
      <div className="pt-24 pb-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 animate-slide-up">
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-gradient-freefire rounded-full text-sm font-semibold mb-4">
              <Gamepad2 className="w-4 h-4" />
              <span>Free Fire Tournament</span>
            </div>
            
            <h1 className="text-5xl sm:text-6xl font-bold mb-4">
              <span className="bg-gradient-freefire bg-clip-text text-transparent">
          ...
          {/* Game Info */}
          <div className="glass-effect rounded-xl p-6 mb-8 border border-red-500/20">
            <div className="flex items-start space-x-3">
              <Info className="w-6 h-6 text-red-400 flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-lg font-semibold text-red-400 mb-3">About Free Fire</h3>
